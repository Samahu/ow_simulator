...
void Cosimulator::update(const ignition::math::Pose3d& tool_pose, double timestep, ignition::math::Vector3d& out_force,
...
void Cosimulator::setToolMesh(const std::string& path_to_mesh)
{
  ...
  gzwarn << "Cosimulator::setToolMesh     path_to_mesh=" << path_to_mesh << std::endl;

  // set the value of tool_mesh, convert if needed
}

void Cosimulator::setParticleProperties(double youngs_modulus, double poisson_ratio, double restitution_coef,
                                        double friction_static, double friction_rolling, double density, double radius)
{
...
void Cosimulator::setToolProperties(double youngs_modulus, double poisson_ratio, double restitution_coef,
